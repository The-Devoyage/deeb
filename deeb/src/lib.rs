...
//!     name = "user",
//!     primary_key = "_id",
//!     associate = ("comment", "_id", "user_id", "user_comment"),
//!     )]
//! struct User {
//!      // Auto Generated by Deeb!
//!      _id: String,
//!     name: String,
//!     age: i32
//! }
...
//!
//!    // Single Operations
//!    User::insert_one::<InsertUserModel>(&db, InsertUserModel {name: "George".to_string(), age: 10}, None).await?;
//!    User::find_one(&db, Query::eq("name", "George"), None).await?;
//!
//!    // Perform a transaction
//!    let mut transaction = db.begin_transaction().await;
//!
//!     // Define models that are used for specific operations
//!     #[derive(Serialize, Deserialize)]
//!     struct InsertUserModel {
//!         name: String,
//!         age: i32
//!     }
//!
//!    let user = User::insert_one::<InsertUserModel>(&db, InsertUserModel {name: "Steve".to_string(), age: 3}, Some(&mut transaction)).await?;
//!    User::insert_one::<InsertUserModel>(&db, InsertUserModel {name: "Johnny".to_string(), age: 3}, Some(&mut transaction)).await?;
//!    Comment::insert_many(
//!           &db,
//!           vec![
//!               Comment {
...
//!    let update = UpdateUserModel { age: Some(5), name: None };
